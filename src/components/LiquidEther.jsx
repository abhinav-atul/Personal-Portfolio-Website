...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      // In src/components/LiquidEther.jsx inside class MouseClass

      init(container) {
        this.container = container;
        // Change listeners to 'window' to capture events through overlaying content
        ...
        // Use document/window for enter/leave to detect if cursor leaves the viewport
